...
file_in = "MultijetBalanceAlgo/scripts/sampleLists/MC15a_EXOT2_gridSamples.txt"
output_tag = "MJB_MC_v11"  # CHANGE BEFORE SUBMITTING - no periods!
...
output_tag = "MJB_PC_v11"  # CHANGE BEFORE SUBMITTING - no periods!
