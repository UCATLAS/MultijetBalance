...
m_outputIntermediary

## Create samples & append them to the sample list
sample_list = []

sample_Rel207 = DataSample(inputWildcard="Rel207")
sample_Rel21 = DataSample(inputWildcard="Rel21")
sample_Pythia = MCSample(inputWildcard="Pythia")
sample_Sherpa = MCSample(inputWildcard="Sherpa")




# -----------------------------------------------------
## Begin manipulating input histograms

for sample in sample_list:
  sample.gatherInput()

gatherInput will
    collect files in hist
    scale them for MC
